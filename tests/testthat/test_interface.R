...
#   set.seed(1000)
#   rf1 <- crazyforest(Species ~ ., tb, num.trees = 5)
...
#   skip_if_not_installed("tibble")
#   set.seed(1000)
#   rf1 <- crazyforest(dependent.variable.name = "Species", data = tb, num.trees = 5)

#   set.seed(1000)
#   rf2 <- crazyforest(dependent.variable.name = "Species", data = iris, num.trees = 5)
