...
hshrink_regr <- function(left_children, right_children, num_samples_nodes, node_predictions, split_values, lambda, nodeID, parent_n, parent_pred, cum_sum) {
    invisible(.Call(`_crazyforest_hshrink_regr`, left_children, right_children, num_samples_nodes, node_predictions, split_values, lambda, nodeID, parent_n, parent_pred, cum_sum))
}
...
hshrink_prob <- function(left_children, right_children, num_samples_nodes, class_freq, lambda, nodeID, parent_n, parent_pred, cum_sum) {
    invisible(.Call(`_crazyforest_hshrink_prob`, left_children, right_children, num_samples_nodes, class_freq, lambda, nodeID, parent_n, parent_pred, cum_sum))
}

replace_class_counts <- function(class_counts_old, class_counts_new) {
    invisible(.Call(`_crazyforest_replace_class_counts`, class_counts_old, class_counts_new))
}
